...
class itti_s11_remote_peer_not_responding : public itti_s11_msg {
 public:
  ...
  itti_s11_remote_peer_not_responding(
      ...
      : itti_s11_msg(i) {}
  itti_s11_remote_peer_not_responding(
      const itti_s11_remote_peer_not_responding& i, const task_id_t orig,
...
class itti_s11_create_session_request : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_create_session_request).name();
  };
...
class itti_s11_create_session_response : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_create_session_response).name();
  };
...
class itti_s11_create_bearer_response : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_create_bearer_response).name();
  };
...
class itti_s11_modify_bearer_request : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_modify_bearer_request).name();
  };
...
class itti_s11_modify_bearer_response : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_modify_bearer_response).name();
  };
...
class itti_s11_delete_session_request : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_delete_session_request).name();
  };
...
class itti_s11_delete_session_response : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_delete_session_response).name();
  };
...
class itti_s11_release_access_bearers_request : public itti_s11_msg {
 public:
  ...
  itti_s11_release_access_bearers_request(
      const itti_s11_release_access_bearers_request& i, const task_id_t orig,
      const task_id_t dest)
      : itti_s11_msg(i, orig, dest) {
    gtp_ies = i.gtp_ies;
  }
  const char* get_msg_name() {
    return typeid(itti_s11_release_access_bearers_request).name();
  };
...
class itti_s11_release_access_bearers_response : public itti_s11_msg {
 public:
  ...
  itti_s11_release_access_bearers_response(
      const itti_s11_release_access_bearers_response& i)
      : itti_s11_msg(i) {
    gtp_ies = i.gtp_ies;
  }
  itti_s11_release_access_bearers_response(
      const itti_s11_release_access_bearers_response& i, const task_id_t orig,
      const task_id_t dest)
      : itti_s11_msg(i, orig, dest) {
    gtp_ies = i.gtp_ies;
  }
  const char* get_msg_name() {
    return typeid(itti_s11_release_access_bearers_response).name();
  };
...
class itti_s11_delete_bearer_command : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_delete_bearer_command).name();
  };
...
class itti_s11_downlink_data_notification : public itti_s11_msg {
 public:
  ...
  itti_s11_downlink_data_notification(
      const itti_s11_downlink_data_notification& i, const task_id_t orig,
      const task_id_t dest)
      : itti_s11_msg(i, orig, dest) {
    gtp_ies = i.gtp_ies;
  }
  itti_s11_downlink_data_notification(
      const gtpv2c::gtpv2c_downlink_data_notification& ies,
      const task_id_t orig, const task_id_t dest)
      : itti_s11_downlink_data_notification(orig, dest) {
    gtp_ies = ies;
  }
  const char* get_msg_name() {
    return typeid(itti_s11_downlink_data_notification).name();
  };
...
class itti_s11_downlink_data_notification_acknowledge : public itti_s11_msg {
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_downlink_data_notification_acknowledge).name();
  };
...
class itti_s11_downlink_data_notification_failure_indication
 ...
 public:
  ...
  const char* get_msg_name() {
    return typeid(itti_s11_downlink_data_notification_failure_indication)
        .name();
  };
